...
const Navbar = () => {
    ...
    <img onClick={()=>setShowSearch(true)} src={assets.SearchIcon} className='w-6 cursor-pointer' alt='search-icon'></img>

    <div className='group relative'>
        <Link to="/Login"><img src={assets.ProfileIcon} className='w-6 cursor-pointer' alt='profile-icon'></img></Link>
